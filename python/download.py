"""
	...
	Run as follows:
	python download.py <position_of_course_in_list> <unit_number> <slides_or_notes> <starting_lecture_number> <ending_lecture_number>	(pass 3 to download slides, 4 to download notes)
	example:
	python download.py 3 2 3 5 12
...
def download(args):
	...
	for i in range(int(args[4]),int(args[5])+1):
		...
		time.sleep(2)
		driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/div[3]/div[2]/div/div[3]/div/div[1]/table/tbody/tr[' + args[1] + ']/td[2]').click()		# Click course name
		time.sleep(2)
		driver.find_element_by_xpath('/html/body/div[3]/div[2]/div/div[2]/div/div[1]/div/ul/li[' + args[2] + ']/a').click()									# Click on the desired unit
		time.sleep(2)
